...
export default function Livro() {
  return (
    <div className={`flex w-full text-center items-center flex-col ${FontMaquina.className}`}>
      <p className="md:m-3 md:mt-10 p-5 w-full md:w-96 bg-zinc-800 md:rounded text-2xl">Capítulo 1</p>
      ...
      <div className="w-full md:w-auto">
        <p className="md:m-3 md:mt-10 p-5 w-full md:w-auto bg-zinc-800 md:rounded text-2xl">Capítulo 2</p>
        <div className="flex flex-col items-center md:flex-row">
          <Link
            href="/livro/Cap2"
            className="m-5 p-5 w-44 rounded-lg bg-zinc-900"
          >
            <div>
              <p>Parte 1</p>
      ...
      <div className="w-full md:w-auto">
        <p className="md:m-3 md:mt-10 p-5 w-full md:w-auto bg-zinc-800 md:rounded text-2xl">Capítulo 3</p>
        <div>
          <div className="flex flex-col items-center md:flex-row">
            <Link
              href="/livro/Cap3"
              className="m-5 p-5 w-60 rounded-lg bg-zinc-900"
            >
              <div>
                <p>Parte 1</p>
