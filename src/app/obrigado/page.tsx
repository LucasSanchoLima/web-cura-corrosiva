  ...
  return (
    <div>
      ...
      <div className={`max-w-6xl mx-auto mb-20 text-justify p-3 indent-4 sm:indent-8 text-2xl mt-10 ${RomanAntique.className}`}>
        ...
        <p className="my-2">
          Espero que tenha gostado do primeiro de 6 arcos que compõe o livro, ainda temos muita coisa pela frente. Eu irei publicar cada arco assim que ele estiver pronto, então reafirmo a inportância de colocar seu email no Receber Novidades, onde
          avisarei assim que um novo capítulo ou arco for lançado.
        </p>
        {/* e todos que fizerem uma assinatura terão acesso à eles. */}
