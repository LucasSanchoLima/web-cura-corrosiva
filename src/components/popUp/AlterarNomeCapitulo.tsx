...
import { alterarNomeCapitulo } from "@/components/funcoes/funcoes";
...
export default function AlterarNomeLivro() {
  ...
  async function criarNome(formData: FormData) {
    const resultado = await alterarNomeCapitulo(await user!.getIdToken(), String(formData.get("nome")), variaveis[0], variaveis[1]);
