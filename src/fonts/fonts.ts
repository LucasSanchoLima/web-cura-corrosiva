...
export const Alice = localFont({ src: "./BlackChencery.ttf" });
export const Radio = localFont({ src: "./Murrx.ttf" });
// export const FontMaquina = Noto_Serif({ weight: ["400"], subsets: ["latin"] });
export const FontMaquina = localFont({ src: "./NotoSerif-Regular.ttf" });
